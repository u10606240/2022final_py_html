...
$result3 = mysqli_query($connect, "SELECT age0_10,age11_20,age21_30,age31_40,age41_50,age51_60,age61_70,age71_80,age81_90,age91_100,year,month FROM p_numbers where year = '$y' and city_id = '$id' and gender = 1");
$result4 = mysqli_query($connect, "SELECT age0_10,age11_20,age21_30,age31_40,age41_50,age51_60,age61_70,age71_80,age81_90,age91_100,year,month FROM p_numbers where year = '$y' and city_id = '$id' and gender = 2");
if(!$result)
{
